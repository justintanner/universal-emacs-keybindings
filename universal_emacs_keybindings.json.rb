...
def control_keys(unless_emacs)
  ...
  [
    ...
    },                  
    {
      ...
      "to" => [
        Karabiner.set_variable("C-spacebar", Karabiner.variable_if("C-spacebar", 1)["value"] == 1 ? 1 : 0)
      ],
      "conditions" => [unless_emacs],
    }
  ]
...
def option_keys(unless_emacs)
  ...
  [
    ...
    },
    {
      ...
      "from" => {
        "key_code" => "period",
        "modifiers" => Karabiner.from_modifiers(["shift", "option"]),
      },
